...
## Latest generation
- Generation: 165
- Run: 20260708T082317Z (167 games, Elo 1373.9206447094496)
- Recent Elo trend per recorded game/run point: -4.152

## Promotion decisions
- rich_leaf / rich_leaf: games=61 promoted=False reason=HOLD rich_leaf: failed ['conservative_promotes_candidate', 'beats_champion_head_to_head', 'elo_improvement', 'trueskill_improvement'].
- heuristic_tuning / heuristic_tune: games=54 promoted=False reason=HOLD heuristic_tune: failed ['conservative_promotes_candidate', 'conservative:beats_runner_up_h2h', 'beats_champion_head_to_head', 'elo_improvement', 'trueskill_improvement'].
...
- History rows: 165
- By kind: {'legacy_generation': 123, 'approach_comparison': 42}
- Approach-comparison rows: 42 · legacy rows: 123 · unknown rows: 0
- Malformed rows: 0
- Duplicate keys: 0
