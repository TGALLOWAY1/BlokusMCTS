...
## Latest generation
- Generation: 177
- Run: 20260711T075529Z (155 games, Elo 1418.0684110056804)
- Recent Elo trend per recorded game/run point: -6.430
...
- Under game floor: {}
- Candidate game counts: {'rich_leaf': 56, 'heuristic_tune': 50, 'mcts_sweep': 49}
...
- History rows: 177
- By kind: {'legacy_generation': 123, 'approach_comparison': 54}
- Approach-comparison rows: 54 · legacy rows: 123 · unknown rows: 0
- Malformed rows: 0
- Duplicate keys: 0
