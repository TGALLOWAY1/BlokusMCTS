...
## Latest generation
- Generation: 178
- Run: 20260711T132811Z (156 games, Elo 1407.522672854677)
- Recent Elo trend per recorded game/run point: -1.507

## Promotion decisions
- rich_leaf / rich_leaf: games=57 promoted=False reason=HOLD rich_leaf: failed ['conservative_promotes_candidate', 'beats_champion_head_to_head', 'elo_improvement', 'trueskill_improvement'].
...
- Latest max candidate games: 57 over 2 seeds
- Any candidate satisfiable under latest counts: True
- All created candidates satisfy game floor: True
- Under game floor: {}
- Candidate game counts: {'rich_leaf': 57, 'heuristic_tune': 50, 'mcts_sweep': 49}
...
- History rows: 178
- By kind: {'legacy_generation': 123, 'approach_comparison': 55}
- Approach-comparison rows: 55 · legacy rows: 123 · unknown rows: 0
- Malformed rows: 0
- Duplicate keys: 0
