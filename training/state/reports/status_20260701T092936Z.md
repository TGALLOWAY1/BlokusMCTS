...
_Updated 2026-07-01 15:08 UTC · run `20260701T092936Z`_
...
- **Elo move vs best:** -155.3 — real (beyond noise) (σ≈±81)
...
- **Current champion TrueSkill:** 22.17 ± 5.07
- **Best historical Elo:** 1379
- **Best historical TrueSkill μ:** 36.40
- **Promotion frequency:** 0.0% (0/94 runs)
...
- **Confidence:** medium
- _Based on 7 recent point(s) (+29.94 Elo/day, sd 68.63)._

## Training Trends

- **7-day Elo trend:** +209.0 over 7 run(s)
- **30-day Elo trend:** +77.2 over 30 run(s)
- **7-day TrueSkill μ trend:** +5.66
