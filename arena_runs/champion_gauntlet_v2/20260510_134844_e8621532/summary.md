# Arena Run Summary: 20260510_134844_e8621532
...
- `champion`: avg_time_ms=4045.995172756372, avg_sims_per_move=250.0, sims_per_sec=61.7894953714651, win_rate_per_sec=0.09474389290291316, score_per_sec=23.1298677673851
- `pool_heuristic`: avg_time_ms=33.342449272384926, avg_sims_per_move=None, sims_per_sec=None, win_rate_per_sec=3.4990430880941013, score_per_sec=2471.324146791034
- `pool_l45_100ms`: avg_time_ms=1560.926955057671, avg_sims_per_move=50.0, sims_per_sec=32.03224842648237, win_rate_per_sec=0.005338708071080395, score_per_sec=48.443437036983504
- `pool_peer_500ms`: avg_time_ms=4364.6441878630485, avg_sims_per_move=250.0, sims_per_sec=57.278437654823186, win_rate_per_sec=0.11264759405448559, score_per_sec=21.861270371590848
...
|------|-------|----|-------|-------------------------|-------|
| 1 | `pool_peer_500ms` | 50.60 | 7.04 | **29.49** | 60 |
| 2 | `champion` | 41.25 | 6.94 | **20.43** | 60 |
| 3 | `pool_heuristic` | 11.94 | 6.76 | **-8.34** | 60 |
| 4 | `pool_l45_100ms` | -2.51 | 6.93 | **-23.30** | 60 |
